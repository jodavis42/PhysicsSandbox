...
public:
  ...
  static IntersectionResult2d Test(const Ray2d& ray, const Aabb2d& aabb, RayResult2d& result, float parallelEpsilonCheck = 0.001f);
  static IntersectionResult2d Test(const Ray2d& ray, const Circle2d& circle, RayResult2d& result);
  static IntersectionResult2d Test(const Ray2d& ray, const Obb2d& obb, RayResult2d& result);
};
